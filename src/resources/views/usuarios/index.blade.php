			...
			<div class="flex justify-between h-16">
				...
				<div class="flex items-center space-x-4">
					<div class="text-sm text-gray-700">
						<span class="font-medium">{{ session('usuario_autenticado')['nombre_completo'] }}</span>
						<span class="text-gray-500">({{ session('usuario_autenticado')['rol_nombre'] }})</span>
					</div>
					...
					<div class="relative">
						...
						>
							<div class="h-8 w-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-medium">
								{{ substr(session('usuario_autenticado')['nombre_completo'], 0, 1) }}
							</div>
						</button>
			...
			<div class="flex space-x-8">
				<div class="relative">
					...
					<div id="configDropdown" class="hidden absolute left-0 mt-0 w-56 bg-white rounded-md shadow-lg py-1 z-50">
						<a href="{{ route('usuarios.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 bg-blue-50">
